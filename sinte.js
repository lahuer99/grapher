...
var numArr=[];
var catArr=[];
$('div#table tr:first-child td').each(function(){
...
$('div#table td.'+$('#pieoffopt').val()).each(function(){
  var k=$(this).html().split(',');
  k.sort()
  var kk=k.join(',')
...
var finder=[];
  ...
  $('div#table td.'+$('#venndiffwhat').val()).each(function(){

    var k=$(this).html().split(',')
    k.sort()
    
    for(var zz=0;zz<k.length;zz++){
      if(finder.includes(k[zz])){
      }
      else{
        arr.push({val:k[zz],text:k[zz]});
        finder.push(k[zz])
      }
    }
    var kk=k.join(',')
...
$('#butt').on("click",function(){
  ...
  $('#graphsetsection').addClass('sider')
   ...
   switch(ty){
      ...
      case 'combi':
                  ...
                  for(var i=0;i<$('select#ywhat').val().length;i++){
                    yy=[];
                        $('div#table td.'+$('select#ywhat').val()[i]).each(function(){
                  ...
                  if(r==""){
                    r=$('div#table th.'+$('select#xwhat').val()).html() + ' vs ' +$('div#table th.'+$('select#ywhat').val()).html()
                  }
                  titlee={
                    text:r
                  }
...
function boiler(){
              ...
              seriess=[];
               chartt={
                ...
                xx=[];
                $('div#table td.'+$('#xwhat').val()).each(function(){
                     var k=$(this).html().split(',');
                     k.sort()
                     var kk=k.join(',')
                     xx.push(kk)
                ...
                for(var i=0;i<$('#ywhat').val().length;i++){
                    ...
                    $('div#table td.'+$('#ywhat').val()[i]).each(function(){
                       if(dict[xx[j]]){
...
function labelSetter(){
                    if($('#titlename').val()==""){
                        r=$('div#table th.'+$('select#xwhat').val()).html()+' vs ( '
                            for(var i=0;i<$('select#ywhat').val().length;i++){
                              r+=$('div#table th.'+$('select#ywhat').val()[i]).html()+', '
                        }
                        r+=')'  
                    }
                    else{
                    ...
                    if($('#xaxisname').val()==""){
                      xname=$('div#table th.'+$('select#xwhat').val()).html()
                    }
                    else{
                      xname=$('#xaxisname').val()
                    }
...
function scatterbubbler(typee){
                  ...
                  xx=[]
                  $('div#table td.'+$('select#xwhat1').val()).each(function(){
                    xx.push(Number($(this).html()))
                  });

                  yy=[];
                  $('div#table td.'+$('select#ywhat1').val()).each(function(){
                    yy.push(Number($(this).html()))
                  })

                  zz=[];
                  $('div#table td.'+$('select#zwhat').val()).each(function(){
...
function labelSetter2(){
                    if($('#titlename').val()==""){
                        r=$('div#table th.'+$('select#xwhat1').val()).html()+' vs ( '
                    ...
                    if($('#xaxisname').val()==""){
                      xname=$('div#table th.'+$('select#xwhat1').val()).html()
                    }
                    else{
                      xname=$('#xaxisname').val()
                    }
                    ...
                    if($('#yaxisname').val()==""){
                      yname=$('div#table th.'+$('select#ywhat1').val()).html()
                    }
                    else{
                      yname=$('#yaxisname').val()
                    }
          ...
          $(document).ready(function(){
            var json={};
                 ...
                 for(var i=0;i<$('select#histwhat').val().length;i++){
                  da=[];
                  $('div#table td.'+$('select#histwhat').val()[i]).each(function(){
...
function histoSetter(){
                    ...
                    if($('#titlename').val()==""){
                      ...
                      for(var i=0;i<$('#histwhat').val().length;i++){
                        r+=$('div#table th.'+$('#histwhat').val()[i]).html()+', '
                      }
                    }
                    else{
                      r=$('#titlename').val()
...
if($('input#checkbox2[type="checkbox"]').is(":checked")){
              ...
              $('#piewantedlabel').show();
                ...
                for(var i=0;i<$('#pieopt').val().length;i++){
                    ...
                    $('div#table td.'+$('#pieopt').val()[i]).each(function(){
                       if(dict[piarr[j]]){
                ...
                var basesets=[];dataa=[];
                 for(var i=0;i<$('#basesetselect').val().length;i++){
                  ...
                  for(var kk=0;kk<xxx.length;kk++){
                    ...
                    for(var ll=0;ll<segments.length;ll++){
                      if(!darr.includes(segments[ll])){
                        flag=1;
                      }
                    }


                    if(flag==0 && !darr.includes(xxx[kk])){
                      darr.push(xxx[kk]);
                    }
                  ...
                  $('div#table td.'+$('#vennforwhat').val()).each(function(){
